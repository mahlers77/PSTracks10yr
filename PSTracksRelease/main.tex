...
%%%%%%%%%%%%%%%%%
\begin{figure*}[t]
\subfloat[IC40]{\includegraphics[scale=0.5]{PSTracksRelease/PublicReleasePlots/EffectiveAreaPlots/IC40_effectiveArea.pdf}}
\hfill
\subfloat[IC59]{\includegraphics[scale=0.5]{PSTracksRelease/PublicReleasePlots/EffectiveAreaPlots/IC59_effectiveArea.pdf}}
\subfloat[IC79]{\includegraphics[scale=0.5]{PSTracksRelease/PublicReleasePlots/EffectiveAreaPlots/IC79_effectiveArea.pdf}}
\hfill
\subfloat[IC86-I]{\includegraphics[scale=0.5]{PSTracksRelease/PublicReleasePlots/EffectiveAreaPlots/IC86_2011_effectiveArea.pdf}}
\subfloat[IC86-II-VII]{\includegraphics[scale=0.5]{PSTracksRelease/PublicReleasePlots/EffectiveAreaPlots/IC86_2012_effectiveArea.pdf}}
